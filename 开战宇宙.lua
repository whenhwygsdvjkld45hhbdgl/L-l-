                    ...
                    pcall(function()
                        ...
                        if character and character:FindFirstChild("HumanoidRootPart") then
                            for i,v in pairs(game:GetService("Workspace").Map:GetDescendants()) do
                                if v.Name == "BoundingBox" and v.Parent:FindFirstChild("bValues") and v.Parent.bValues:FindFirstChild("Health") and v.Parent.bValues.Health.Value > v.Parent.bValues.MaxHealth.Value/2 and (character.HumanoidRootPart.Position-v.Position).Magnitude < _G.distance then
                        ...
                        if _G.rat then
                            ...
                            until game.Players.LocalPlayer:DistanceFromCharacter(_G.rat.Position) < 60 or not _G.test
        ...
        if state then
            task.spawn(function()
                while _G.autospawn do
                    task.wait()
                    pcall(function()
                        if _G.crack and game:GetService("Players").LocalPlayer.PlayerGui.newUI.PlayingUI.Visible == false then
                            ...
                            task.wait(10)
                        elseif _G.crack2 and game:GetService("Players").LocalPlayer.PlayerGui.newUI.PlayingUI.Visible == false then
