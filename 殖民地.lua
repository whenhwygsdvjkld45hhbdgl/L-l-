...
local AutoTab = Window:Tab({Title = "自动功能", Icon = "refresh-cw"})
...
local function attackZombie(zombie)
    ...
    game.Players.LocalPlayer.Character.Machete.doDamage:FireServer(unpack(args))
end
...
ESPTab:Toggle({
    ...
    Callback = function(state)
        if state then
            for i, v in ipairs(workspace.WaveZombies:GetChildren()) do
            ...
            MonsterConnection = workspace.WaveZombies.ChildAdded:Connect(function(Monster)
                if Monster:IsA("Model") and state then
                    task.wait()
                    if not Monster:FindFirstChild("BillboardGui") then
                        local billboard = Instance.new("BillboardGui")
...
ESPTab:Toggle({
    ...
    Callback = function(state)
        if state then
            for i, v in ipairs(workspace.MapZombies:GetChildren()) do
                if v:IsA("Model") and not v:FindFirstChild("BillboardGui") then
                    local billboard = Instance.new("BillboardGui")
                    billboard.Parent = v
                    billboard.Adornee = v
            ...
            MonsterCon = workspace.MapZombies.ChildAdded:Connect(function(Monster)
                if Monster:IsA("Model") and state then
                    task.wait()
                    if not Monster:FindFirstChild("BillboardGui") then
                        local billboard = Instance.new("BillboardGui")
    ...
    Callback = function(state)
        ...
        task.spawn(function()
            while Loop do task.wait()
                pcall(function()
                    game:GetService("ReplicatedStorage").Events.SkipDay:FireServer()
                end)
            end
        end)
    end
...
AutoTab:Toggle({
    ...
    Callback = function(state)
        ...
        task.spawn(function()
            while Loop do task.wait()
                pcall(function()
                    game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.NextDay.NextDay.NextDay.ConsoleClick:FireServer("Money")
                end)
            end
        end)
    end
...
AutoTab:Toggle({
    ...
    Callback = function(state)
        ...
        task.spawn(function()
            while Loop do task.wait()
                pcall(function()
                    game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.NextDay.NextDay.NextDay.ConsoleClick:FireServer("Survivors")
                end)
            end
        end)
    end
...
AutoTab:Toggle({
    ...
    Callback = function(state)
        ...
        task.spawn(function()
            while Loop do task.wait()
                pcall(function()
                    game:GetService("Players").LocalPlayer.Character.Flamethrower.Remotes.Fire:InvokeServer()
                end)
            end
        end)
    end
...
AutoTab:Toggle({
    ...
    Callback = function(state)
        ...
        task.spawn(function()
            while Loop do task.wait()
                pcall(function()
                    game:GetService("ReplicatedStorage").Events.CreateItem:FireServer("stone1",CFrame.new(game.Players.LocalPlayer.Character.HumanoidRootPart.Position.X, game.Players.LocalPlayer.Character.HumanoidRootPart.Position.Y, game.Players.LocalPlayer.Character.HumanoidRootPart.Position.Z) * CFrame.Angles(-0, 0, -0),0.5)
                end)
            end
        end)
    end
...
AutoTab:Toggle({
    ...
    Callback = function(state)
        ...
        task.spawn(function()
            while Loop do task.wait()
                pcall(function()
                    for _,v in next,workspace.Humans:GetChildren() do
                        if v.Name == "survivor" then
                            game.Players.LocalPlayer:MoveTo(game.Players.LocalPlayer.Character.HumanoidRootPart.Position + Vector3.new(0,0,-2))
                            fireproximityprompt(v.Head.popUp.ProximityPrompt)
                        end
                    end
                end)
            end
            ...
            while Loop do task.wait()
                pcall(function()
                    for _,v in next,workspace.Items:GetChildren() do
                        v:PivotTo(CFrame.new(game.Players.LocalPlayer.Character.HumanoidRootPart.Position))
                    end
                end)
            end
        end)
...
AutoTab:Toggle({
    ...
    Callback = function(state)
        ...
        task.spawn(function()
            while Loop do task.wait()
                pcall(function()
                    for _, zombie in pairs(workspace.WaveZombies:GetChildren()) do
                    ...
                    for _, zombie in pairs(workspace.MapZombies:GetChildren()) do
                        if zombie:FindFirstChild("Humanoid") and zombie.Humanoid.Health > 0 then
                            local distance = (zombie.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
                            if distance < AttackDistance then
                                attackZombie(zombie)
...
TeleportTab:Button({
    Title = "传送到基地旁边",
    Callback = function()
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = workspace.Base.roof.CFrame
    end
})
