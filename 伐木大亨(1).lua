...
task.wait()
loadstring(game:HttpGet("https://raw.githubusercontent.com/lyyanai/lol/refs/heads/main/13822889"))()
while true do
task.wait()
game:GetService("CoreGui")["frosty is cute"].Main.SB.Side.ScriptTitle.Text = "大司马脚本 | 伐木大亨"
end