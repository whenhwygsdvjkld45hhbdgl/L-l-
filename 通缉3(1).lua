...
WindUI:Popup({
    ...
    IconThemed = true,
    Icon = "crown",
    Content = "欢迎大司马脚本付费版的用户 " .. coloredUsername .. " \n使用大司马脚本付费版\n感谢购买\n欢迎使用付费版",
    Buttons = {
        {
            Title = "取消",
...
local chatSystem = {
    ...
    chatModes = {
        ...
        ["宣传词"] = function() return {"大司马脚本牛逼牛逼", "打败一切", "快来购买", "功能多多", "支持超多服务器"} end
    },
    connections = {},
    active = false
}
...
Settings:Button({
    ...
    Callback = function()
        ...
        setclipboard("大司马 设置: " .. game:GetService("HttpService"):JSONEncode(settings))
        playSound()
    end
})
