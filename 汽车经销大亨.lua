...
local Tab1 = Window:Tab({Title = "自动功能", Icon = "settings"})
local Tab2 = Window:Tab({Title = "比赛功能", Icon = "trophy"})
                    ...
                    if tycoon then
                        pcall(function()
                            for i,v in pairs(tycoon.Dealership.Purchases:GetChildren()) do 
                                if getfenv().buyer and v.TycoonButton.Button.Transparency == 0 then
                ...
                while _G.racetest3 do
                    ...
                    if game:GetService("Players").LocalPlayer.PlayerGui.Menu.Race.Visible == false then
                        ...
                        if chr and chr:FindFirstChild("Humanoid") and chr.Humanoid.SeatPart then
                            ...
                            until game:GetService("Players").LocalPlayer.PlayerGui.Menu.Race.Visible == true or not _G.racetest3
                        end
